...
export default function DigitalSkillsPage() {
  const impactStats = [
    ...
    { number: "12", label: "Months Program", icon: GraduationCap },
    { number: "15+", label: "Skill Tracks", icon: Code },
    { number: "90%", label: "Completion Rate", icon: Award },
  ]
  ...
  const mainTopics = [
    ...
    {
      title: "Data Analysis",
      description: "Learn to collect, analyze, and visualize data to extract meaningful insights.",
      icon: BarChart,
      color: "from-teal-500 to-cyan-500",
    },
    {
      title: "Robotics & IoT",
      description: "Build and program robots, work with sensors, and create smart devices.",
      icon: Cpu,
      color: "from-cyan-500 to-blue-500",
    },
    {
      title: "Digital Design",
      description: "Develop visual communication skills through graphic design and UI/UX.",
      icon: Palette,
  ...
  const applicationPrograms = [
    {
      ...
      duration: "16 weeks",
      description:
        "Comprehensive training in modern web development. Learn HTML, CSS, JavaScript, React, Node.js, and database management. Build real-world projects and create a professional portfolio. Perfect for beginners with no prior coding experience.",
      startDate: "March 20, 2025",
      email: "webdev@stempowerethiopia.org",
      image: "/ethiopian-students-learning-coding-in-computer-lab.jpg",
      status: "Applications Open",
      googleFormUrl: "https://forms.google.com/web-development-bootcamp",
    },
    {
      title: "Data Science & Analytics Program",
      duration: "14 weeks",
      description:
        "Master data analysis, visualization, and statistical thinking. Learn Excel, SQL, Python, and Power BI. Work on real datasets and solve business problems through data-driven insights. Industry certification included.",
      startDate: "April 5, 2025",
      email: "datascience@stempowerethiopia.org",
      image: "/young-professionals-data-analysis-training-ethiop.jpg",
      status: "Applications Open",
      googleFormUrl: "https://forms.google.com/data-science-analytics",
    },
    {
      title: "UI/UX Design Masterclass",
      duration: "10 weeks",
      description:
        "Learn user-centered design principles, wireframing, prototyping, and visual design. Master Figma and Adobe XD. Create stunning interfaces and exceptional user experiences. Build a professional design portfolio.",
      startDate: "April 15, 2025",
      email: "design@stempowerethiopia.org",
      image: "/ethiopian-students-working-with-science-equipment-.jpg",
      status: "Applications Open",
      googleFormUrl: "https://forms.google.com/uiux-design-masterclass",
    },
  ]
  ...
  <div className="text-center mb-12">
    ...
    <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
      In today's fast-paced world, digital skills are the key to opportunity and innovation. STEMpower has
      partnered with IBM SkillsBuild to deliver a year-long digital skills training program, equipping students,
      young professionals, and communities with practical expertise in coding, data analysis, robotics, digital
      design, and more.
    </p>
  </div>
  ...
  <div className="grid md:grid-cols-2 gap-8 items-center mb-12">
    ...
    <div className="space-y-4">
      <h3 className="text-2xl font-bold text-gray-900">Powered by IBM SkillsBuild</h3>
      <p className="text-muted-foreground leading-relaxed">
        Through our partnership with IBM SkillsBuild, we provide world-class digital skills training with
        industry-recognized curriculum, cutting-edge learning resources, and globally accepted certifications.
      </p>
  ...
  <div className="max-w-6xl mx-auto px-4">
    ...
    <div className="text-center mb-12">
      ...
      <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty">
        All our digital skills programs are completely free. Apply now to join our next cohort and start your
        journey in tech.
      </p>
    </div>
        ...
        >
          <div className="relative h-48">
            ...
            <div className="absolute top-4 right-4">
              <Badge className="bg-gradient-to-br from-[#367375] to-[#24C3BC] text-white border-none">
                {program.status}
              </Badge>
            </div>
          </div>
